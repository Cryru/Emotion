...
global using SpriteReference = Emotion.Core.Systems.IO.AssetOrObjectReference<Emotion.Core.Systems.IO.XMLAsset<Emotion.Game.World.TwoDee.SpriteEntity>, Emotion.Game.World.TwoDee.SpriteEntity>;
