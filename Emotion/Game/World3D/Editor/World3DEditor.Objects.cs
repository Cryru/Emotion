...
public partial class World3DEditor
{
    ...
    protected override void InitializeObjectEditor()
    {
        ...
        if (MoveGizmo == null)
            Task.Run(async () =>
            {
                ...
                MoveGizmo = gizmo;
                gizmo.TargetMoved = (obj, start, movedTo) =>
                {
                    EditorRegisterMoveAction((BaseGameObject)obj, start, movedTo);
                };
            });
    ...
    protected override void UpdateObjectEditor()
    {
        ...
        if (_selectedObject != null)
        {
            MoveGizmo?.Update(Engine.DeltaTime);
        }
    }
    ...
    public override void SelectObject(BaseGameObject? obj)
    {
        ...
        if (obj != null && MoveGizmo != null)
        {
            MoveGizmo.SetTarget(obj);
        }
    }
}