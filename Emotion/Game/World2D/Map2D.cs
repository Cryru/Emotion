...
namespace Emotion.Game.World2D
{
	public partial class Map2D
	{
		...
		/// </summary>
		private bool _loadingSerializedObjects;
		...
		public async Task InitAsync()
		{
			...
			_loadingSerializedObjects = true;
		...
		public void RemoveObject(GameObject2D obj, bool removeFromMapFile = false)
		{
			...
			if (removeFromMapFile && ObjectsToSerialize.Contains(obj)) ObjectsToSerialize.Remove(obj);
