    ...
    internal struct Simplex
    {
        ...
        internal void ReadCache(ref SimplexCache cache, ref DistanceProxy proxyA, ref PhysicsTransform transformA, ref DistanceProxy proxyB, ref PhysicsTransform transformB)
        {
            ...
            for (int i = 0; i < Count; ++i)
            {
                ...
                v.WA = transformA.TransformVector(wALocal);
                v.WB = transformB.TransformVector(wBLocal);
                v.W = v.WB - v.WA;
                v.A = 0.0f;
                V[i] = v;
            }
            ...
            if (Count > 1)
            {
                ...
                if (metric2 < 0.5f * metric1 || 2.0f * metric1 < metric2 || metric2 < Maths.EPSILON)
                    // Reset the simplex.
                    Count = 0;
            }
        ...
        internal Vector2 GetSearchDirection()
        {
            switch (Count)
            {
                ...
                case 2:
                {
                    ...
                    float sgn = Maths.Cross2D(e12, -V[0].W);
                    if (sgn > 0.0f)
                        // Origin is left of e12.
                        return Maths.Cross2D(1.0f, e12);

                    // Origin is right of e12.
                    return Maths.Cross2D(e12, 1.0f);
                }
        ...
        internal float GetMetric()
        {
            switch (Count)
            {
                ...
                case 2:
                    return Vector2.Distance(V[0].W, V[1].W);

                case 3:
                    return Maths.Cross2D(V[1].W - V[0].W, V[2].W - V[0].W);
        ...
        internal void Solve3()
        {
            ...
            // Triangle123
            float n123 = Maths.Cross2D(e12, e13);

            float d123_1 = n123 * Maths.Cross2D(w2, w3);
            float d123_2 = n123 * Maths.Cross2D(w3, w1);
            float d123_3 = n123 * Maths.Cross2D(w1, w2);
