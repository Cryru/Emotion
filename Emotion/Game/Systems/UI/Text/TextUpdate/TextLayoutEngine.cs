...
public class TextLayoutEngine
{
    ...
    public void Render(Renderer c, Vector3 offset, Color baseColor, FontEffect defaultEffect = FontEffect.None, float defaultEffectAmount = 0f, Color? defaultEffectColor = null)
    {
        RenderWithNoLayoutOffset(c, offset + LayoutRenderOffset, baseColor, defaultEffect, defaultEffectAmount, defaultEffectColor);
    }

    public void RenderWithNoLayoutOffset(Renderer c, Vector3 offset, Color baseColor, FontEffect defaultEffect = FontEffect.None, float defaultEffectAmount = 0f, Color? defaultEffectColor = null)
    {
    ...
    public void RenderTest(Renderer c, Vector3 offset)
    {
