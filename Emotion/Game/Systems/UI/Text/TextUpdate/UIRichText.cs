...
//#endif
    ...
    private class VirtualTextureForRichText : VirtualTextureAtlasTexture
    {
        ...
        public override void VirtualTextureRenderToBatch(Renderer c, Vector2 offset)
        {
    ...
    protected void RenderTextForBatch(Renderer c, Vector2 offset)
    {
    ...
    public void RenderVirtual(Renderer c, Vector3 position, Vector2 space, float scale, Color color)
    {
    ...
    private void RenderBase(Renderer c, Vector3 pos)
    {
