...
namespace OpenGL
{
    public partial class Gl
    {
        ...
        /// </summary>
        [RequiredByFeature("GL_VERSION_4_6")] public const int SHADER_BINARY_FORMAT_SPIR_V = 0x9551;

        /// <summary>
        /// [GL] Value of GL_SPIR_V_BINARY symbol.
        /// </summary>
        [RequiredByFeature("GL_VERSION_4_6")] public const int SPIR_V_BINARY = 0x9552;

        /// <summary>
        /// [GL] Value of GL_PARAMETER_BUFFER symbol.
        /// </summary>
        [RequiredByFeature("GL_VERSION_4_6")] public const int PARAMETER_BUFFER = 0x80EE;

        /// <summary>
        /// [GL] Value of GL_PARAMETER_BUFFER_BINDING symbol.
        /// </summary>
        [RequiredByFeature("GL_VERSION_4_6")] public const int PARAMETER_BUFFER_BINDING = 0x80EF;

        /// <summary>
        /// [GL] Value of GL_CONTEXT_FLAG_NO_ERROR_BIT symbol.
        /// </summary>
        [RequiredByFeature("GL_VERSION_4_6")] public const uint CONTEXT_FLAG_NO_ERROR_BIT = 0x00000008;

        /// <summary>
        /// [GL] Value of GL_VERTICES_SUBMITTED symbol.
        /// </summary>
        [RequiredByFeature("GL_VERSION_4_6")] public const int VERTICES_SUBMITTED = 0x82EE;

        /// <summary>
        /// [GL] Value of GL_PRIMITIVES_SUBMITTED symbol.
        /// </summary>
        [RequiredByFeature("GL_VERSION_4_6")] public const int PRIMITIVES_SUBMITTED = 0x82EF;

        /// <summary>
        /// [GL] Value of GL_VERTEX_SHADER_INVOCATIONS symbol.
        /// </summary>
        [RequiredByFeature("GL_VERSION_4_6")] public const int VERTEX_SHADER_INVOCATIONS = 0x82F0;

        /// <summary>
        /// [GL] Value of GL_TESS_CONTROL_SHADER_PATCHES symbol.
        /// </summary>
        [RequiredByFeature("GL_VERSION_4_6")] public const int TESS_CONTROL_SHADER_PATCHES = 0x82F1;

        /// <summary>
        /// [GL] Value of GL_TESS_EVALUATION_SHADER_INVOCATIONS symbol.
        /// </summary>
        [RequiredByFeature("GL_VERSION_4_6")] public const int TESS_EVALUATION_SHADER_INVOCATIONS = 0x82F2;

        /// <summary>
        /// [GL] Value of GL_GEOMETRY_SHADER_PRIMITIVES_EMITTED symbol.
        /// </summary>
        [RequiredByFeature("GL_VERSION_4_6")] public const int GEOMETRY_SHADER_PRIMITIVES_EMITTED = 0x82F3;

        /// <summary>
        /// [GL] Value of GL_FRAGMENT_SHADER_INVOCATIONS symbol.
        /// </summary>
        [RequiredByFeature("GL_VERSION_4_6")] public const int FRAGMENT_SHADER_INVOCATIONS = 0x82F4;

        /// <summary>
        /// [GL] Value of GL_COMPUTE_SHADER_INVOCATIONS symbol.
        /// </summary>
        [RequiredByFeature("GL_VERSION_4_6")] public const int COMPUTE_SHADER_INVOCATIONS = 0x82F5;

        /// <summary>
        /// [GL] Value of GL_CLIPPING_INPUT_PRIMITIVES symbol.
        /// </summary>
        [RequiredByFeature("GL_VERSION_4_6")] public const int CLIPPING_INPUT_PRIMITIVES = 0x82F6;

        /// <summary>
        /// [GL] Value of GL_CLIPPING_OUTPUT_PRIMITIVES symbol.
        /// </summary>
        [RequiredByFeature("GL_VERSION_4_6")] public const int CLIPPING_OUTPUT_PRIMITIVES = 0x82F7;

        /// <summary>
        /// [GL] Value of GL_POLYGON_OFFSET_CLAMP symbol.
        /// </summary>
        [RequiredByFeature("GL_VERSION_4_6")] [RequiredByFeature("GL_ARB_polygon_offset_clamp", Api = "gl|glcore")]
        public const int POLYGON_OFFSET_CLAMP = 0x8E1B;

        /// <summary>
        /// [GL] Value of GL_SPIR_V_EXTENSIONS symbol.
        /// </summary>
        [RequiredByFeature("GL_VERSION_4_6")] [RequiredByFeature("GL_ARB_spirv_extensions", Api = "gl|glcore")]
        ...
        /// </summary>
        [RequiredByFeature("GL_VERSION_4_6")] [RequiredByFeature("GL_ARB_texture_filter_anisotropic", Api = "gl|glcore")]
        ...
        /// </summary>
        [RequiredByFeature("GL_VERSION_4_6")] public const int TRANSFORM_FEEDBACK_OVERFLOW = 0x82EC;

        /// <summary>
        /// [GL] Value of GL_TRANSFORM_FEEDBACK_STREAM_OVERFLOW symbol.
        /// </summary>
        [RequiredByFeature("GL_VERSION_4_6")] public const int TRANSFORM_FEEDBACK_STREAM_OVERFLOW = 0x82ED;
