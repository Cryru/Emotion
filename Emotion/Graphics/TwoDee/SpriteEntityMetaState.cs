...
using PartRuntimeData = (Emotion.Graphics.TwoDee.SpriteAnimationBodyPart part, int relativeTo, Emotion.Graphics.TwoDee.SpriteAnimationFrame? currentFrame, System.Numerics.Vector2 anchor);
    ...
    public void UpdateAnimation(SpriteAnimation? animation, float currentTime, bool forceRecalculate = false)
    {
        ...
        if (_animation != animation || forceRecalculate)
        {
            ...
            if (_animation != null)
            {
                ...
                if (_animation.LoopType == Game.Animation.AnimationLoopType.NormalThenReverse)
