...
namespace Emotion.Core.Utility;
...
public static class Packing
{
    ...
    /// </param>
    /// <param name="fillResumeState">
    /// If a resumable state instance is provided it will be filled with the data needed to
    ...
    public static Vector2 FitRectangles(Memory<Rectangle> rectMemory, bool maintainOrder = false, PackingResumableState fillResumeState = null)
    {
        ...
        for (var i = 0; i < rects.Length; i++)
        {
            ...
            for (var j = 0; j < rects.Length; j++)
            {
                ...
                Assert(!thisRect.Intersects(ref thatRect));
            }
        }
#endif
