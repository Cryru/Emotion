...
using Emotion.Core.Platform.Implementation.Win32.Wgl;
using Emotion.Core.Platform.Implementation.Win32;

#if ANGLE
using Emotion.Core.Platform.Implementation.EglAngle;
#endif
...
public partial class Win32Platform : DesktopPlatform
{
    ...
    private void PollMonitors()
    {
        ...
        var inactive = new List<Core.Platform.MonitorScreen>();
        ...
        foreach (Core.Platform.MonitorScreen inactiveMonitor in inactive)
        {
