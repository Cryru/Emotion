...
public struct KeyboardInputState
{
    ...
    {
        get => unchecked((int) Value >> 24 & 0x1) == 1;
    }
    ...
    {
        get => unchecked((int) Value >> 29 & 0x1) == 1;
    }
    ...
    {
        get => unchecked((int) Value >> 30 & 0x1) == 1;
    }
    ...
    {
        get => unchecked((int) Value >> 31 & 0x1) == 1;
    }
}
