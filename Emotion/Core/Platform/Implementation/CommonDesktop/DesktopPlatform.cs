...
namespace Emotion.Core.Platform.Implementation.CommonDesktop;
...
public abstract class DesktopPlatform : PlatformBase
{
    ...
    protected void UpdateMonitor(MonitorScreen monitor, bool connected, bool first)
    {
        if (connected)
        {
