...
{
    public SerializedAssetHandler(Func<T>? createNew, string typeName, ComplexTypeHandlerMemberBase[] members, Type[] interfaces)
        : base(createNew, typeName, members, interfaces)
    {
    }
