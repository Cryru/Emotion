...
public static class NativeHelpers
{
    ...
    /// </summary>
    public static nint Nullptr = nint.Zero;
    ...
    public static unsafe void MemCopy(nint src, nint dst, int size)
    {
    ...
    public static string StringFromPtr(nint ptr)
    {
    ...
    /// <returns>A <see cref="nint" /> to memory with the string copied.</returns>
    public static nint StringToPtr(string text)
    {
    ...
    /// </summary>
    public static TDelegate GetFunctionByPtr<TDelegate>(nint ptr)
    {
        return ptr == nint.Zero ? default : Marshal.GetDelegateForFunctionPointer<TDelegate>(ptr);
    }

    public static unsafe void ZeroOutMemory(nint ptr, int size)
    {
