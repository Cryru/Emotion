...
namespace SharpFont
{
    ...
    public sealed class GlyphSlot
    {
        ...
        {
            get => new GlyphSlot(rec.next, Face, Library);
        }
        ...
        {
            get => new GlyphMetrics(rec.metrics);
        }
        ...
        {
            get => Fixed16Dot16.FromRawValue((int) rec.linearHoriAdvance);
        }
        ...
        {
            get => Fixed16Dot16.FromRawValue((int) rec.linearVertAdvance);
        }
        ...
        {
            get => new FTBitmap(PInvokeHelper.AbsoluteOffsetOf<GlyphSlotRec>(Reference, "bitmap"), rec.bitmap, Library);
        }
        ...
        {
            get => new Outline(PInvokeHelper.AbsoluteOffsetOf<GlyphSlotRec>(Reference, "outline"), rec.outline);
        }
