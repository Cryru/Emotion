...
namespace SharpFont
{
    ...
    public static partial class FT
    {
        ...
        {
            return Fixed16Dot16.FromRawValue((int) FT_MulDiv((IntPtr) a.Value, (IntPtr) b.Value, (IntPtr) c.Value));
        }
        ...
        {
            return Fixed16Dot16.FromRawValue((int) FT_MulFix((IntPtr) a, (IntPtr) b.Value));
        }
        ...
        {
            return Fixed16Dot16.FromRawValue((int) FT_DivFix((IntPtr) a, (IntPtr) b.Value));
        }
        ...
        {
            return Fixed16Dot16.FromRawValue((int) FT_RoundFix((IntPtr) a.Value));
        }
        ...
        {
            return Fixed16Dot16.FromRawValue((int) FT_FloorFix((IntPtr) a.Value));
        }
        ...
        {
            return Fixed16Dot16.FromRawValue((int) FT_Sin((IntPtr) angle.Value));
        }
        ...
        {
            return Fixed16Dot16.FromRawValue((int) FT_Cos((IntPtr) angle.Value));
        }
        ...
        {
            return Fixed16Dot16.FromRawValue((int) FT_Tan((IntPtr) angle.Value));
        }
        ...
        {
            return Fixed16Dot16.FromRawValue((int) FT_Atan2((IntPtr) x.Value, (IntPtr) y.Value));
        }
        ...
        {
            return Fixed16Dot16.FromRawValue((int) FT_Angle_Diff((IntPtr) angle1.Value, (IntPtr) angle2.Value));
        }
