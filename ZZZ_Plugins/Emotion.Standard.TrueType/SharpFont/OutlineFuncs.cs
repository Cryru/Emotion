...
namespace SharpFont
{
    ...
    public class OutlineFuncs : IDisposable
    {
        ...
        /// <paramref name="moveTo" />, <paramref name="lineTo" />,
        /// <paramref name="conicTo" />, or <paramref name="cubicTo" /> is <see langword="null" />.
        /// </exception>
        public OutlineFuncs(MoveToFunc moveTo, LineToFunc lineTo, ConicToFunc conicTo, CubicToFunc cubicTo, int shift, int delta)
        {
            if (moveTo == null) throw new ArgumentNullException(nameof(moveTo));
            if (lineTo == null) throw new ArgumentNullException(nameof(lineTo));
            if (conicTo == null) throw new ArgumentNullException(nameof(conicTo));
            if (cubicTo == null) throw new ArgumentNullException(nameof(cubicTo));
        ...
        public MoveToFunc MoveFunction
        {
            ...
            {
                ThrowIfDisposed();
                if (moveToPin.IsAllocated) moveToPin.Free();
                moveToFunc = value;
        ...
        public LineToFunc LineFunction
        {
            ...
            {
                ThrowIfDisposed();
                if (lineToPin.IsAllocated) lineToPin.Free();
                lineToFunc = value;
        ...
        public ConicToFunc ConicFunction
        {
            ...
            {
                ThrowIfDisposed();
                if (conicToPin.IsAllocated) conicToPin.Free();
                conicToFunc = value;
        ...
        public CubicToFunc CubicFunction
        {
            ...
            {
                ThrowIfDisposed();
                if (cubicToPin.IsAllocated) cubicToPin.Free();
                cubicToFunc = value;
        ...
        internal OutlineFuncsRec Record
        {
            ...
            {
                ThrowIfDisposed();
                OutlineFuncsRec r = new OutlineFuncsRec();
                r.moveTo = moveToPtr;
                r.lineTo = lineToPtr;
        ...
        {
            if (isDisposed) throw new ObjectDisposedException("OutlineFuncs", "The outline funcs has already been disposed.");
        }
