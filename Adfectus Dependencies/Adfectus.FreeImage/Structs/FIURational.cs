...
{
    /// <summary>
    /// The <b>FIURational</b> structure represents a fraction via two <see cref="uint" />
    ...
    public struct FIURational : IConvertible, IComparable, IFormattable, IComparable<FIURational>, IEquatable<FIURational>
    {
        ...
        /// </summary>
        public static readonly FIURational MaxValue = new FIURational(uint.MaxValue, 1u);
        ...
        /// </summary>
        public static readonly FIURational Epsilon = new FIURational(1u, uint.MaxValue);
        ...
        public FIURational(decimal value)
        {
            try
            {
                if (value < 0) throw new OverflowException("value");
        ...
        private static void ApproximateFraction(decimal value, int maxDen, out uint num, out uint den)
        {
            ...
            {
                uint numerator = (uint) Math.Floor(value * u + 0.5m);
                currentDifference = Math.Abs(value - numerator / (decimal) u);
        ...
        /// <returns>
        /// <b>true</b> if <paramref name="obj" /> is a <see cref="FIURational" /> structure
        /// equivalent to this <see cref="FIURational" /> structure; otherwise, <b>false</b>.
        /// </returns>
        ...
        {
            right.Normalize();
            if (Math.Abs(right.numerator) < right.denominator) return new FIURational(0, 0);
        ...
        public int CompareTo(object obj)
        {
            ...
            if (!(obj is FIURational)) throw new ArgumentException();
        ...
        /// <summary>
        /// Tests whether the specified <see cref="FIURational" /> structure is equivalent to this <see cref="FIURational" />
        /// structure.
        /// </summary>
