...
namespace FreeImageAPI
{
    ...
    public unsafe class MemoryArray<T> : IDisposable, ICloneable, ICollection, IEnumerable<T>, IEquatable<MemoryArray<T>> where T : struct
    {
        ...
        /// <paramref name="length" /> is less or equal zero.
        /// </exception>
        ...
        public MemoryArray(void* baseAddress, int length)
        {
            if (typeof(T) == typeof(FI1BIT))
                isOneBit = true;
            else if (typeof(T) == typeof(FI4BIT)) isFourBit = true;
        ...
        {
            EnsureNotDisposed();
            if (isOneBit) return (T) (object) (FI1BIT) ((baseAddress[index / 8] & (1 << (7 - index % 8))) == 0 ? 0 : 1);
        ...
        {
            EnsureNotDisposed();
            if (index >= this.length || index < 0) throw new ArgumentOutOfRangeException("index");

            if (index + length > this.length || length < 1) throw new ArgumentOutOfRangeException("length");
        ...
        /// </param>
        /// <exception cref="ArgumentNullException">
        /// <paramref name="values" /> is a null reference (Nothing in Visual Basic).
        /// </exception>
        /// <exception cref="ArgumentOutOfRangeException">
        /// <paramref name="index" /> is outside the range of valid indexes
        ...
        public void SetValues(T[] values, int index)
        {
            ...
            if (index + values.Length > length) throw new ArgumentOutOfRangeException("values.Length");
        ...
        /// </summary>
        /// <param name="array">
        /// The one-dimensional <see cref="System.Array" /> that is the destination
        ...
        {
            EnsureNotDisposed();
            if (!(array is T[])) throw new InvalidCastException("array");
        ...
        public void CopyTo(T[] array, int sourceIndex, int destinationIndex, int length)
        {
            ...
            if (sourceIndex >= this.length || sourceIndex < 0) throw new ArgumentOutOfRangeException("sourceIndex");

            if (destinationIndex >= array.Length || destinationIndex < 0) throw new ArgumentOutOfRangeException("destinationIndex");
        ...
        public void CopyFrom(T[] array, int sourceIndex, int destinationIndex, int length)
        {
            ...
            if (destinationIndex >= this.length || destinationIndex < 0) throw new ArgumentOutOfRangeException("destinationIndex");

            if (sourceIndex >= array.Length || sourceIndex < 0) throw new ArgumentOutOfRangeException("sourceIndex");
        ...
        public T[] Data
        {
            get => GetValues(0, length);
            set
            {
                if (value == null) throw new ArgumentNullException("value");

                if (value.Length != length) throw new ArgumentOutOfRangeException("value.Lengt");
        ...
        {
            if (baseAddress == null) throw new ObjectDisposedException("This instance is disposed.");
        }
        ...
        /// <returns>
        /// <b>true</b> if <paramref name="obj" /> is a <see cref="MemoryArray&lt;T&gt;" />
        ...
        /// <returns>
        /// <b>true</b> if <paramref name="other" /> is equivalent to this
