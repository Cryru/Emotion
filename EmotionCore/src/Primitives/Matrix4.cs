...
namespace Emotion.Primitives
{
    ...
    public struct Matrix4 : IEquatable<Matrix4>
    {
        ...
        public float Trace
        {
            get => Row0.X + Row1.Y + Row2.Z + Row3.W;
        }
        ...
        /// <exception cref="Emotion.Engine.Threading.ArgumentOutOfRangeException">
        ...
        {
            Multiply(ref left, right, out Matrix4 result);
            return result;
        }
        ...
        public static void Invert(ref Matrix4 mat, out Matrix4 result)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                if (pivot == 0.0f) throw new InvalidOperationException("Matrix is singular and cannot be inverted.");
