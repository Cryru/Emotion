...
{
    /// <summary>
    /// Color class from Mono.XNA. Modified.
    /// </summary>
    public struct Color : IEquatable<Color>
    {
        ...
        public Color(Color color, int alpha)
        {
            ...
            G = color.G;
            B = color.B;
            A = (byte) GameMath.Clamp(alpha, byte.MinValue, byte.MaxValue);
        }
        ...
        public Color(Color color, float alpha)
        {
            ...
            G = color.G;
            B = color.B;
            A = (byte) GameMath.Clamp(alpha * 255, byte.MinValue, byte.MaxValue);
        }
        ...
        public Color(float r, float g, float b)
        {
            ...
            R = (byte) GameMath.Clamp(r * 255, byte.MinValue, byte.MaxValue);
            G = (byte) GameMath.Clamp(g * 255, byte.MinValue, byte.MaxValue);
            B = (byte) GameMath.Clamp(b * 255, byte.MinValue, byte.MaxValue);
            A = 255;
        }
        ...
        {
            PackedValue = 0;
            R = (byte) GameMath.Clamp(r, byte.MinValue, byte.MaxValue);
            G = (byte) GameMath.Clamp(g, byte.MinValue, byte.MaxValue);
            B = (byte) GameMath.Clamp(b, byte.MinValue, byte.MaxValue);
            A = 255;
        }
        ...
        public static Color Lerp(Color value1, Color value2, float amount)
        {
            ...
            return new Color(
                (int) GameMath.Lerp(value1.R, value2.R, amount),
                (int) GameMath.Lerp(value1.G, value2.G, amount),
                (int) GameMath.Lerp(value1.B, value2.B, amount),
                (int) GameMath.Lerp(value1.A, value2.A, amount));
        }
