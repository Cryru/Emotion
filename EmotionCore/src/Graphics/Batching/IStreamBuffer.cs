...
namespace Emotion.Graphics.Batching
{
    ...
    public abstract class StreamBuffer : IRenderable
    {
        ...
        /// <param name="endIndex">The index of the object to stop drawing at. If null will draw to MappedObjects.</param>
        ...
        /// <param name="endIndex">The index of the vertex to stop drawing at. If null will draw to MappedVertices.</param>
        public abstract void SetRenderRangeVertices(uint startIndex = 0, uint? endIndex = null);
