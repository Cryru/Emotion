...
namespace Emotion.Graphics.GLES
{
    public sealed class VertexArray : IGLObject
    {
        ...
        /// <param name="componentCount">The component count of the buffer. If under or equal to 0 the component count within the buffer object will be used.</param>
        ...
        public void AttachBuffer(Buffer buffer, int index, int stride = 0, int offset = 0, int componentCount = -1, VertexAttribPointerType byteType = VertexAttribPointerType.Float, bool normalized = false)
        {
