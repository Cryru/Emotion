...
namespace FreeImageAPI
{
    ...
    public sealed class Palette : MemoryArray<RGBQUAD>
    {
        ...
        /// <paramref name="dib" /> is not
        /// <see cref="FREE_IMAGE_TYPE.FIT_BITMAP" />
        /// <para />
        /// -or-
        /// <para />
        /// <paramref name="dib" /> has more than 8bpp.
        /// </exception>
            ...
            : base(FreeImage.GetPalette(dib), (int) FreeImage.GetColorsUsed(dib))
        {
            ...
            if (FreeImage.GetBPP(dib) > 8u) throw new ArgumentException("dib");
        }
        ...
        /// <exception cref="ArgumentException">
        /// <paramref name="tag" /> is not
        /// <see cref="FREE_IMAGE_MDTYPE.FIDT_PALETTE" />.
        /// </exception>
        public Palette(FITAG tag)
            : base(FreeImage.GetTagValue(tag), (int) FreeImage.GetTagCount(tag))
        {
            if (FreeImage.GetTagType(tag) != FREE_IMAGE_MDTYPE.FIDT_PALETTE) throw new ArgumentException("tag");
        }
        ...
        public Palette(RGBQUAD[] palette)
        {
            unsafe
            {
                ...
                baseAddress = (byte*) paletteHandle.AddrOfPinnedObject();
                length = array.Length;
        ...
        /// <param name="splitSize">
        /// The position of the color within the new palette.
        /// 0 &lt; <paramref name="splitSize" /> &lt; <see cref="MemoryArray&lt;T&gt;.Length" />.
        /// </param>
        /// <remarks>
        /// Only call this method on linear palettes.
        /// </remarks>
        ...
        {
            EnsureNotDisposed();
            if (splitSize < 1 || splitSize >= length) throw new ArgumentOutOfRangeException("splitSize");
        ...
        /// <paramref name="palette" /> is a null reference.
        /// </exception>
        public void CopyFrom(Palette palette)
        {
            ...
            CopyFrom(palette.Data, 0, 0, Math.Min(palette.Length, Length));
        }
        ...
        /// <paramref name="offset" /> is outside the range of valid indexes.
        /// </exception>
        public void CopyFrom(Palette palette, int offset)
        {
            EnsureNotDisposed();
            CopyFrom(palette.Data, 0, offset, Math.Min(palette.Length, Length - offset));
        }
        ...
        {
            if (paletteHandle.IsAllocated) paletteHandle.Free();
