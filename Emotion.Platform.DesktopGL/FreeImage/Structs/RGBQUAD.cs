...
namespace FreeImageAPI
{
    ...
    public struct RGBQUAD : IComparable, IComparable<RGBQUAD>, IEquatable<RGBQUAD>
    {
        ...
        public int CompareTo(object obj)
        {
            ...
            if (!(obj is RGBQUAD)) throw new ArgumentException("obj");
        ...
        /// <returns>
        /// <b>true</b> if <paramref name="obj" /> is a <see cref="RGBQUAD" /> structure
        /// equivalent to this <see cref="RGBQUAD" /> structure; otherwise, <b>false</b>.
        /// </returns>
