...
namespace SharpFont
{
    ...
    public sealed class Face : NativeObject, IDisposable
    {
        ...
        {
            get => (FaceFlags & FaceFlags.Horizontal) == FaceFlags.Horizontal;
        }
        ...
        {
            get => (FaceFlags & FaceFlags.Vertical) == FaceFlags.Vertical;
        }
        ...
        {
            get => (FaceFlags & FaceFlags.Kerning) == FaceFlags.Kerning;
        }
        ...
        {
            get => (FaceFlags & FaceFlags.Scalable) == FaceFlags.Scalable;
        }
        ...
        public bool IsSfnt
        {
            get => (FaceFlags & FaceFlags.Sfnt) == FaceFlags.Sfnt;
        }
        ...
        {
            get => (FaceFlags & FaceFlags.FixedWidth) == FaceFlags.FixedWidth;
        }
        ...
        {
            get => (FaceFlags & FaceFlags.FixedSizes) == FaceFlags.FixedSizes;
        }
        ...
        {
            get => (FaceFlags & FaceFlags.GlyphNames) == FaceFlags.GlyphNames;
        }
        ...
        {
            get => (FaceFlags & FaceFlags.MultipleMasters) == FaceFlags.MultipleMasters;
        }
        ...
        {
            get => (FaceFlags & FaceFlags.CidKeyed) == FaceFlags.CidKeyed;
        }
        ...
        {
            get => (FaceFlags & FaceFlags.Tricky) == FaceFlags.Tricky;
        }
        ...
        {
            get => (FaceFlags & FaceFlags.Color) == FaceFlags.Color;
        }
        ...
        public object GetSfntTable(SfntTag tag)
        {
            ...
            {
                case SfntTag.Header:
                    return new TrueType.Header(tableRef);
        ...
        ///     </para>
        ///     <para>
        ///     If <see cref="LoadFlags.VerticalLayout" /> is set, these are the vertical advances corresponding to a vertical
        ///     layout. Otherwise, they are the horizontal advances in a horizontal layout.
        ///     </para>
        /// </returns>
