...
namespace SharpFont
{
    ...
    public struct Fixed16Dot16 : IEquatable<Fixed16Dot16>, IComparable<Fixed16Dot16>
    {
        ...
        {
            return FromRawValue((int) FT.FT_CeilFix((IntPtr) Value));
        }
        ...
        {
            return FromRawValue((int) FT.FT_Sin((IntPtr) Value));
        }
        ...
        {
            return FromRawValue((int) FT.FT_Cos((IntPtr) Value));
        }
        ...
        {
            return FromRawValue((int) FT.FT_Tan((IntPtr) Value));
        }
