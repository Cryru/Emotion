...
namespace SourceGenerator
{
    ...
    {
        private HashSet<string> _excludedNamespacesSubSpaces = new HashSet<string>()
        {
            "Silk",
            "SixLabors",
            "Roslyn",
        ...
        private HashSet<string> _excludedNamespacesTypes = new HashSet<string>()
        {
            "<global namespace>" // Global namespace
        };
        private HashSet<string> _forceIncludeSubspaces = new HashSet<string>()
        {
            "System.Numerics"
        };

        private StringBuilder _reflectorTypeGetCodeGen = null;
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            _reflectorTypeGetCodeGen = new StringBuilder();
