...
namespace Adfectus.Game.UI
{
    ...
    public abstract class Control : TransformRenderable
    {
        ...
        /// </summary>
        public bool[] Held { get; internal set; } = new bool[Enum.GetNames(typeof(MouseKey)).Length];
        ...
        public virtual void MouseDown(MouseKey key)
        {
        }
        ...
        public virtual void MouseUp(MouseKey key)
        {
        }
