...
namespace Adfectus.Game.UI
{
    ...
    public abstract class ParentControl : Control
    {
        ...
        public virtual void AddChild(Transform transform)
        {
            ...
            Engine.Log.Trace($"[{this}] added child transform {transform}.", MessageSource.UIController);
        ...
        {
            Engine.Log.Trace($"[{this}] removed child transform {transform}.", MessageSource.UIController);
        ...
        public override void Render()
        {
            foreach (Transform child in _children)
            {
                ...
                if (child is Control childControl)
                {
                    ...
                    Engine.Renderer.Render(childControl);
                    continue;
                }

                // Check if the child is a transform renderable.
                if (child is TransformRenderable childRenderable) Engine.Renderer.Render(childRenderable);
            }
        }
