...
namespace Adfectus.Common.Threading
{
    ...
    public class ThreadManager
    {
        ...
        /// </summary>
        private ConcurrentQueue<AwAction> _queue = new ConcurrentQueue<AwAction>();
        ...
        public void Run()
        {
            ...
            {
                bool dequeued = _queue.TryDequeue(out AwAction task);
        ...
        public AwAction ExecuteOnThread(Action action)
        {
            // Wrap the action in a task.
            AwAction completionTask = new AwAction(action);
