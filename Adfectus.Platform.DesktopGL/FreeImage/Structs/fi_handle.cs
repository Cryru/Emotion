...
namespace FreeImageAPI.IO
{
    ...
    public struct fi_handle : IComparable, IComparable<fi_handle>, IEquatable<fi_handle>, IDisposable
    {
        ...
        /// <returns>
        /// <b>true</b> if <paramref name="obj" /> is a <see cref="fi_handle" /> structure
        /// equivalent to this <see cref="fi_handle" /> structure; otherwise, <b>false</b>.
        /// </returns>
        ...
        public int CompareTo(object obj)
        {
            ...
            if (!(obj is fi_handle)) throw new ArgumentException("obj");
