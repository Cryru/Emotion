...
namespace FreeImageAPI
{
    ...
    public struct RGBTRIPLE : IComparable, IComparable<RGBTRIPLE>, IEquatable<RGBTRIPLE>
    {
        ...
        public int CompareTo(object obj)
        {
            ...
            if (!(obj is RGBTRIPLE)) throw new ArgumentException("obj");
        ...
        /// <returns>
        /// <b>true</b> if <paramref name="obj" /> is a <see cref="RGBTRIPLE" /> structure
        /// equivalent to this <see cref="RGBTRIPLE" /> structure; otherwise, <b>false</b>.
        /// </returns>
