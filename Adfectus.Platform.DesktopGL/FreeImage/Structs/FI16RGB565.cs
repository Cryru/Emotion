...
namespace FreeImageAPI
{
    ...
    public struct FI16RGB565 : IComparable, IComparable<FI16RGB565>, IEquatable<FI16RGB565>
    {
        ...
        public byte Red
        {
            get => (byte) (((value & FreeImage.FI16_565_RED_MASK) >> FreeImage.FI16_565_RED_SHIFT) * 255 / 31);
            set => this.value = (ushort) ((this.value & ~FreeImage.FI16_565_RED_MASK) | ((value * 31 / 255) << FreeImage.FI16_565_RED_SHIFT));
        }
        ...
        public byte Green
        {
            get => (byte) (((value & FreeImage.FI16_565_GREEN_MASK) >> FreeImage.FI16_565_GREEN_SHIFT) * 255 / 63);
            set => this.value = (ushort) ((this.value & ~FreeImage.FI16_565_GREEN_MASK) | ((value * 63 / 255) << FreeImage.FI16_565_GREEN_SHIFT));
        }
        ...
        public byte Blue
        {
            get => (byte) (((value & FreeImage.FI16_565_BLUE_MASK) >> FreeImage.FI16_565_BLUE_SHIFT) * 255 / 31);
            set => this.value = (ushort) ((this.value & ~FreeImage.FI16_565_BLUE_MASK) | ((value * 31 / 255) << FreeImage.FI16_565_BLUE_SHIFT));
        }
        ...
        public int CompareTo(object obj)
        {
            ...
            if (!(obj is FI16RGB565)) throw new ArgumentException("obj");
        ...
        /// <returns>
        /// <b>true</b> if <paramref name="obj" /> is a <see cref="FI16RGB565" /> structure
        /// equivalent to this <see cref="FI16RGB565" /> structure; otherwise, <b>false</b>.
        /// </returns>
        ...
        /// <summary>
        /// Tests whether the specified <see cref="FI16RGB565" /> structure is equivalent to this <see cref="FI16RGB565" />
        /// structure.
        /// </summary>
