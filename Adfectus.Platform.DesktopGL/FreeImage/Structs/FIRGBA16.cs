...
namespace FreeImageAPI
{
    ...
    public struct FIRGBA16 : IComparable, IComparable<FIRGBA16>, IEquatable<FIRGBA16>
    {
        ...
        public Color Color
        {
            get => Color.FromArgb(alpha >> 8, red >> 8, green >> 8, blue >> 8);
            set
            {
        ...
        public int CompareTo(object obj)
        {
            ...
            if (!(obj is FIRGBA16)) throw new ArgumentException("obj");
        ...
        /// <returns>
        /// <b>true</b> if <paramref name="obj" /> is a <see cref="FIRGBA16" /> structure
        /// equivalent to this <see cref="FIRGBA16" /> structure; otherwise, <b>false</b>.
        /// </returns>
