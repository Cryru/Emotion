...
namespace FreeImageAPI
{
    ...
    public struct FIRGB16 : IComparable, IComparable<FIRGB16>, IEquatable<FIRGB16>
    {
        ...
        public Color Color
        {
            get => Color.FromArgb(red >> 8, green >> 8, blue >> 8);
            set
            {
        ...
        public int CompareTo(object obj)
        {
            ...
            if (!(obj is FIRGB16)) throw new ArgumentException("obj");
        ...
        /// <returns>
        /// <b>true</b> if <paramref name="obj" /> is a <see cref="FIRGB16" /> structure
        /// equivalent to this <see cref="FIRGB16" /> structure; otherwise, <b>false</b>.
        /// </returns>
