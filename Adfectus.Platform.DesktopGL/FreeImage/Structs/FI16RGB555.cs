...
namespace FreeImageAPI
{
    ...
    public struct FI16RGB555 : IComparable, IComparable<FI16RGB555>, IEquatable<FI16RGB555>
    {
        ...
        public byte Red
        {
            get => (byte) (((value & FreeImage.FI16_555_RED_MASK) >> FreeImage.FI16_555_RED_SHIFT) * 255 / 31);
            set => this.value = (ushort) ((this.value & ~FreeImage.FI16_555_RED_MASK) | ((value * 31 / 255) << FreeImage.FI16_555_RED_SHIFT));
        }
        ...
        public byte Green
        {
            get => (byte) (((value & FreeImage.FI16_555_GREEN_MASK) >> FreeImage.FI16_555_GREEN_SHIFT) * 255 / 31);
            set => this.value = (ushort) ((this.value & ~FreeImage.FI16_555_GREEN_MASK) | ((value * 31 / 255) << FreeImage.FI16_555_GREEN_SHIFT));
        }
        ...
        public byte Blue
        {
            get => (byte) (((value & FreeImage.FI16_555_BLUE_MASK) >> FreeImage.FI16_555_BLUE_SHIFT) * 255 / 31);
            set => this.value = (ushort) ((this.value & ~FreeImage.FI16_555_BLUE_MASK) | ((value * 31 / 255) << FreeImage.FI16_555_BLUE_SHIFT));
        }
        ...
        public int CompareTo(object obj)
        {
            ...
            if (!(obj is FI16RGB555)) throw new ArgumentException("obj");
        ...
        /// <returns>
        /// <b>true</b> if <paramref name="obj" /> is a <see cref="FI16RGB555" /> structure
        /// equivalent to this <see cref="FI16RGB555" /> structure; otherwise, <b>false</b>.
        /// </returns>
        ...
        /// <summary>
        /// Tests whether the specified <see cref="FI16RGB555" /> structure is equivalent to this <see cref="FI16RGB555" />
        /// structure.
        /// </summary>
