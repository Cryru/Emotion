...
namespace FreeImageAPI.Metadata
{
    ...
    public sealed class MetadataTag : IComparable, IComparable<MetadataTag>, ICloneable, IEquatable<MetadataTag>, IDisposable
    {
        ...
        public MetadataTag(FREE_IMAGE_MDMODEL model)
        {
            ...
            if (model == FREE_IMAGE_MDMODEL.FIMD_XMP) Key = "XMLPacket";
        }
        ...
        {
            if (tag.IsNull) throw new ArgumentNullException("tag");
        ...
        private static FREE_IMAGE_MDMODEL GetModel(FIBITMAP dib, FITAG tag)
        {
            ...
            {
                FIMETADATA mData = FreeImage.FindFirstMetadata_(model, dib, out value);
                ...
                try
                {
                    do
                    {
                        if (value == tag) return model;
                    } while (FreeImage.FindNextMetadata_(mData, out value));
                }
                finally
                {
        ...
        public string Key
        {
            ...
            {
                CheckDisposed();
                return FreeImage.GetTagKey(tag);
            }
            set
            {
                CheckDisposed();
                if (model != FREE_IMAGE_MDMODEL.FIMD_XMP || value == "XMLPacket") FreeImage.SetTagKey(tag, value);
            }
        }
        ...
        public string Description
        {
            ...
            {
                CheckDisposed();
                return FreeImage.GetTagDescription(tag);
            }
            set
            {
                CheckDisposed();
                FreeImage.SetTagDescription(tag, value);
            }
        }
        ...
        public ushort ID
        {
            ...
            {
                CheckDisposed();
                return FreeImage.GetTagID(tag);
            }
            set
            {
                CheckDisposed();
                FreeImage.SetTagID(tag, value);
            }
        }
        ...
        public FREE_IMAGE_MDTYPE Type
        {
            ...
            {
                CheckDisposed();
                return FreeImage.GetTagType(tag);
            }
        ...
        public uint Count
        {
            ...
            {
                CheckDisposed();
                return FreeImage.GetTagCount(tag);
            }
        ...
        public uint Length
        {
            ...
            {
                CheckDisposed();
                return FreeImage.GetTagLength(tag);
            }
        ...
        public object Value
        {
            get
            {
                unsafe
                {
                    ...
                    if (Type == FREE_IMAGE_MDTYPE.FIDT_NOTYPE) return null;
        ...
        public bool SetValue(object value)
        {
            ...
            if (!typeList.ContainsKey(type)) throw new NotSupportedException("The type of value is not supported");
        ...
        /// <paramref name="value" /> and <paramref name="type" /> to not fit.
        /// </exception>
        ...
        /// <paramref name="value" /> is not Array.
        /// </exception>
        /// <exception cref="NotSupportedException">
        /// <paramref name="type" /> is FIDT_NOTYPE.
        /// </exception>
        private bool SetArrayValue(object value, FREE_IMAGE_MDTYPE type)
        {
            ...
            else
            {
                ...
                if (array == null) throw new ArgumentException("value");
        ...
        public bool AddToImage(FIBITMAP dib)
        {
            ...
            if (!selfCreated)
            {
                ...
                if (tag.IsNull) throw new FreeImageException("FreeImage.CloneTag() failed.");

                selfCreated = true;
            }

            if (!FreeImage.SetMetadata_(Model, dib, Key, tag)) return false;

            FREE_IMAGE_MDMODEL _model = Model;
            string _key = Key;
            selfCreated = false;
            FreeImage.DeleteTag(tag);
            return FreeImage.GetMetadata_(_model, dib, _key, out tag);
        }
        ...
        /// <returns>
        /// <b>true</b> if <paramref name="obj" /> is a <see cref="MetadataTag" /> instance
        /// equivalent to this <see cref="MetadataTag" /> instance; otherwise, <b>false</b>.
        /// </returns>
        ...
        /// <summary>
        /// Tests whether the specified <see cref="MetadataTag" /> instance is equivalent to this <see cref="MetadataTag" />
        /// instance.
        /// </summary>
        /// <param name="other">A <see cref="MetadataTag" /> instance to compare to this instance.</param>
        /// <returns>
        /// <b>true</b> if <paramref name="obj" /> equivalent to this <see cref="MetadataTag" /> instance;
        /// otherwise, <b>false</b>.
        /// </returns>
        ...
        public int CompareTo(object obj)
        {
            ...
            if (!(obj is MetadataTag)) throw new ArgumentException("obj");
