...
namespace FreeImageAPI.Metadata
{
    ...
    public abstract class MetadataModel : IEnumerable
    {
        ...
        /// </summary>
        public abstract FREE_IMAGE_MDMODEL Model { get; }
        ...
        public int AddTag(IEnumerable<MetadataTag> list)
        {
            ...
            {
                if (tag.Model == Model && tag.AddToImage(dib)) count++;
            }
        ...
        public bool RemoveTag(string key)
        {
            ...
            return FreeImage.SetMetadata_(Model, dib, key, FITAG.Zero);
        }
        ...
        {
            return FreeImage.SetMetadata_(Model, dib, null, FITAG.Zero);
        }
        ...
        /// <see cref="FreeImageAPI.Metadata.MetadataModel" />.
        /// </returns>
        ...
        public int Count
        {
            get => (int) FreeImage.GetMetadataCount(Model, dib);
        }
        ...
        /// <exception cref="ArgumentNullException">
        /// <typeparamref name="searchPattern" /> is null.
        /// </exception>
        /// <exception cref="ArgumentException">
        /// <typeparamref name="searchPattern" /> is empty.
        /// </exception>
        public List<MetadataTag> RegexSearch(string searchPattern, MD_SEARCH_FLAGS flags)
        {
            ...
            foreach (MetadataTag tag in list)
            {
                ...
                if ((flags & MD_SEARCH_FLAGS.TOSTRING) > 0 && regex.Match(tag.ToString()).Success) result.Add(tag);
            }
        ...
        {
            SetTagValue(key, value.HasValue ? new[] {value.Value} : null);
        }
        ...
        /// <returns>
        /// The equivalent <see cref="DirectionReference" /> for the
        /// specified <see cref="String" />.
        /// </returns>
        ...
        /// <returns>
        /// The equivalent <see cref="String" /> for the
        /// specified <see cref="DirectionReference" />.
        /// </returns>
        ...
        /// <returns>
        /// The equivalent <see cref="VelocityUnit" /> for the
        /// specified <see cref="String" />.
        /// </returns>
        ...
        /// <returns>
        /// The equivalent <see cref="LongitudeType" /> for the
        /// specified <see cref="String" />.
        /// </returns>
        ...
        /// <returns>
        /// The equivalent <see cref="LatitudeType" /> for the
        /// specified <see cref="String" />.
        /// </returns>
        ...
        /// <returns>
        /// The equivalent <see cref="InteroperabilityMode" /> for the
        /// specified <see cref="String" />.
        /// </returns>
        protected static InteroperabilityMode? ToInteroperabilityType(string s)
        {
            ...
            if (s.StartsWith("R98")) return InteroperabilityMode.R98;

            if (s.StartsWith("THM")) return InteroperabilityMode.THM;
