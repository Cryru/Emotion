...
namespace SharpFont
{
    ...
    public sealed class Library : IDisposable
    {
        ...
        /// <param name="moduleName">The module name.</param>
        /// <param name="propertyName">
        /// The property name. Properties are described in the ‘Synopsis’ subsection of the
        /// module's documentation.
        /// </param>
        /// <param name="value">
        /// A generic pointer to a variable or structure which gives the value of the property. The
