...
namespace SharpFont
{
    ...
    public sealed class FTStream : NativeObject
    {
        ...
        {
            get => new StreamDesc(PInvokeHelper.AbsoluteOffsetOf<StreamRec>(Reference, "descriptor"));
        }
        ...
        {
            get => new StreamDesc(PInvokeHelper.AbsoluteOffsetOf<StreamRec>(Reference, "pathname"));
        }
        ...
        {
            get => new Memory(PInvokeHelper.AbsoluteOffsetOf<StreamRec>(Reference, "memory"));
        }
