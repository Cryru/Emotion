...
namespace ImGuiNET
{
    ...
    public unsafe struct ImFontAtlasPtr
    {
        ...
        public ref ImFontAtlasFlags Flags
        {
            get => ref Unsafe.AsRef<ImFontAtlasFlags>(&NativePtr->Flags);
        }

        public ref IntPtr TexID
        {
            get => ref Unsafe.AsRef<IntPtr>(&NativePtr->TexID);
        }

        public ref int TexDesiredWidth
        {
            get => ref Unsafe.AsRef<int>(&NativePtr->TexDesiredWidth);
        }

        public ref int TexGlyphPadding
        {
            get => ref Unsafe.AsRef<int>(&NativePtr->TexGlyphPadding);
        }

        public ref bool Locked
        {
            get => ref Unsafe.AsRef<bool>(&NativePtr->Locked);
        }

        public ref bool TexReady
        {
            get => ref Unsafe.AsRef<bool>(&NativePtr->TexReady);
        }

        public ref bool TexPixelsUseColors
        {
            get => ref Unsafe.AsRef<bool>(&NativePtr->TexPixelsUseColors);
        }
        ...
        public ref int TexWidth
        {
            get => ref Unsafe.AsRef<int>(&NativePtr->TexWidth);
        }

        public ref int TexHeight
        {
            get => ref Unsafe.AsRef<int>(&NativePtr->TexHeight);
        }

        public ref Vector2 TexUvScale
        {
            get => ref Unsafe.AsRef<Vector2>(&NativePtr->TexUvScale);
        }

        public ref Vector2 TexUvWhitePixel
        {
            get => ref Unsafe.AsRef<Vector2>(&NativePtr->TexUvWhitePixel);
        }

        public ImVector<ImFontPtr> Fonts
        {
            get => new ImVector<ImFontPtr>(NativePtr->Fonts);
        }

        public ImPtrVector<ImFontAtlasCustomRectPtr> CustomRects
        {
            get => new ImPtrVector<ImFontAtlasCustomRectPtr>(NativePtr->CustomRects, Unsafe.SizeOf<ImFontAtlasCustomRect>());
        }

        public ImPtrVector<ImFontConfigPtr> ConfigData
        {
            get => new ImPtrVector<ImFontConfigPtr>(NativePtr->ConfigData, Unsafe.SizeOf<ImFontConfig>());
        }

        public RangeAccessor<Vector4> TexUvLines
        {
            get => new RangeAccessor<Vector4>(&NativePtr->TexUvLines_0, 64);
        }
        ...
        public ref int PackIdMouseCursors
        {
            get => ref Unsafe.AsRef<int>(&NativePtr->PackIdMouseCursors);
        }

        public ref int PackIdLines
        {
            get => ref Unsafe.AsRef<int>(&NativePtr->PackIdLines);
        }
        ...
        public ImFontPtr AddFontFromFileTTF(string filename, float size_pixels)
        {
            ...
            if (filename_byteCount > Util.StackAllocationSizeLimit) Util.Free(native_filename);
            return new ImFontPtr(ret);
        }
        ...
        public ImFontPtr AddFontFromMemoryCompressedBase85TTF(string compressed_font_data_base85, float size_pixels)
        {
            ...
            if (compressed_font_data_base85_byteCount > Util.StackAllocationSizeLimit) Util.Free(native_compressed_font_data_base85);
            return new ImFontPtr(ret);
        }
