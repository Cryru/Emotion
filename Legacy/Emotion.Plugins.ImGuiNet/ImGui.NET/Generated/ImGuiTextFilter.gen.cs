...
namespace ImGuiNET
{
    ...
    public unsafe struct ImGuiTextFilterPtr
    {
        ...
        {
            NativePtr = (ImGuiTextFilter*) nativePtr;
        }
        ...
        public RangeAccessor<byte> InputBuf
        {
            get => new RangeAccessor<byte>(NativePtr->InputBuf, 256);
        }

        public ImPtrVector<ImGuiTextRangePtr> Filters
        {
            get => new ImPtrVector<ImGuiTextRangePtr>(NativePtr->Filters, Unsafe.SizeOf<ImGuiTextRange>());
        }

        public ref int CountGrep
        {
            get => ref Unsafe.AsRef<int>(&NativePtr->CountGrep);
        }
