...
namespace ImGuiNET
{
    ...
    public unsafe struct ImGuiStoragePtr
    {
        ...
        {
            NativePtr = (ImGuiStorage*) nativePtr;
        }
        ...
        public ImPtrVector<ImGuiStoragePairPtr> Data
        {
            get => new ImPtrVector<ImGuiStoragePairPtr>(NativePtr->Data, Unsafe.SizeOf<ImGuiStoragePair>());
        }
